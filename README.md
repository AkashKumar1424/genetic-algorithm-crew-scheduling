...
Increase crew–flight matching

Enhance scalability in large datasets
...
=1 if crew i is assigned to flight j, else 0

Objective Function:
✔ Minimize total scheduling cost

Constraints:

All flights must be covered

Duty hours ≤ Max Duty Time

Mandatory rest ≥ Min Rest Time

Feasible pairings enforced
